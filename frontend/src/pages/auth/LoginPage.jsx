            ...
            <div className="max-w-md w-full space-y-8 relative z-10">
                <div className="text-center">
                    <h2 className="mt-6 text-4xl font-black text-gray-900 tracking-tight">
                        Welcome <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-red to-accent-green">Back</span>
                    </h2>
                    <p className="mt-2 text-sm text-gray-600">
                        Or{' '}
                        <Link to="/register" className="font-medium text-accent-red hover:text-red-700 transition-colors">
                ...
                <div className="group relative">
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-accent-red to-accent-green rounded-3xl opacity-20 group-hover:opacity-40 transition duration-500 blur"></div>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center">
                                    <input
                                        ...
                                        name="remember-me"
                                        type="checkbox"
                                        className="h-4 w-4 text-accent-green focus:ring-accent-green border-gray-300 rounded transition-colors"
                                    />
                                ...
                                <div className="text-sm">
                                    <a href="#" className="font-bold text-accent-green hover:text-green-700 transition-colors">
